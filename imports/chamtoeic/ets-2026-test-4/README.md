...
- `ets-2026-test-4-full.json`: canonical full JSON for app import/rendering. It contains source
...
```powershell
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-4\fetch.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-4\submit-one-answer.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-4\map-media-to-questions.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-4\fetch-transcripts-and-map.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-4\build-full-json.ps1
```
