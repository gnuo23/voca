...
$outputPath = Join-Path $dir "ets-2026-test-4-full.json"
...
$payload = [ordered]@{
    schemaVersion = 1
    source = [ordered]@{
        page = "https://chamtoeic.edu.vn/tests/ets-2026-test-4"
        overviewApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-4/overview"
        questionsApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-4/questions"
        questionsWithAnswersApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-4/questions?show_answers=true"
