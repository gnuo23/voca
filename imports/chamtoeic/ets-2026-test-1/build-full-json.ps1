...
$outputPath = Join-Path $dir "ets-2026-test-1-full.json"
...
$payload = [ordered]@{
    ...
    source = [ordered]@{
        ...
        overviewApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-1/overview"
        questionsApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-1/questions"
        questionsWithAnswersApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2026-test-1/questions?show_answers=true"
