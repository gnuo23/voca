...
- `ets-2026-test-5-full.json`: canonical full JSON for app import/rendering. It contains source
...
One question has no non-empty explanation text after HTML cleanup:

- Question ID: `b3476fc9-a42f-4bf9-b26a-a7e56e996fbd`
- Correct answer: `B`
...
```powershell
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-5\fetch.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-5\submit-one-answer.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-5\map-media-to-questions.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-5\fetch-transcripts-and-map.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-5\build-full-json.ps1
```
