...
- `ets-2026-test-10-full.json`: canonical full JSON for app import/rendering. It contains source
...
```powershell
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-10\fetch.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-10\submit-one-answer.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-10\map-media-to-questions.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-10\fetch-transcripts-and-map.ps1
powershell -ExecutionPolicy Bypass -File imports\chamtoeic\ets-2026-test-10\build-full-json.ps1
```
