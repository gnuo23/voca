...
$outputPath = Join-Path $dir "ets2024-test-10-full.json"
...
$payload = [ordered]@{
    schemaVersion = 1
    source = [ordered]@{
        page = "https://chamtoeic.edu.vn/tests/ets2024-test-10"
        overviewApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets2024-test-10/overview"
        questionsApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets2024-test-10/questions"
        questionsWithAnswersApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets2024-test-10/questions?show_answers=true"
