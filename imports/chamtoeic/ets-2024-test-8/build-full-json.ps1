...
$outputPath = Join-Path $dir "ets-2024-test-8-full.json"
...
$payload = [ordered]@{
    schemaVersion = 1
    source = [ordered]@{
        page = "https://chamtoeic.edu.vn/tests/ets-2024-test-8"
        overviewApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2024-test-8/overview"
        questionsApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2024-test-8/questions"
        questionsWithAnswersApi = "https://chamtoeic.edu.vn/api/v1/question-bank-service/test-sets/accessible/ets-2024-test-8/questions?show_answers=true"
